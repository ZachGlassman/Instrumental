...
ERR_CODES = {k:v for k,v in list(locals().items()) if k.startswith('IS_')}
ERR_CODE_NAME = {v:k for k,v in list(ERR_CODES.items())}
...
# Gain stuff - ZAG 6/22/2016
IS_GET_MASTER_GAIN =  0x8000
#IS_SET_MASTER_GAIN_FACTOR = 5
